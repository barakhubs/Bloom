...
<div class="container-fluid py-5">
    <div class="container text-center">
        ...
        <h1 class="display-6 mb-4">Making the World a Better Place For All of Us</h1>
...
<div class="container-fluid py-5">
    <div class="container">
        <div class="text-center mx-auto wow fadeIn" data-wow-delay="0.1s" style="max-width: 500px;">
            ...
            <h1 class="display-6 mb-4">Impact at a Glance</h1>
        </div>
        <div class="row g-0 text-center rounded overflow-hidden">
            <?php foreach ($stats as $i => $stat): ?>
                ...
                <div class="col-6 col-md-3 <?= $dark ? 'bg-primary' : 'bg-secondary' ?> py-5 px-3 wow fadeIn" data-wow-delay="<?= 0.1 * ($i + 1) ?>s">
                    <h1 class="display-5 mb-0 <?= $dark ? '' : 'text-white' ?>" data-toggle="counter-up"><?= htmlspecialchars($stat['value']) ?></h1>
...
<div class="container-fluid py-5 bg-light">
    <div class="container">
        <div class="text-center mx-auto wow fadeIn" data-wow-delay="0.1s" style="max-width: 500px;">
            ...
            <h1 class="display-6 mb-4">How Donations Are Allocated</h1>
        </div>
